...
const firebaseConfig = {
    apiKey: "AIzaSyBhRAsn_O-tTwukYhoQc6ialCqZ3wiqB68",
    authDomain: "freshcase-dashboard.firebaseapp.com",
    projectId: "freshcase-dashboard",
    storageBucket: "freshcase-dashboard.firebasestorage.app",
    messagingSenderId: "751439711170",
    appId: "1:751439711170:web:9f733b0477733b190c245b",
    measurementId: "G-G0JMG4TPNS",
    databaseURL: "https://freshcase-dashboard-default-rtdb.firebaseio.com" // Added database URL for Realtime DB
};

// Initialize Firebase
const app = initializeApp(firebaseConfig);
const database = getDatabase(app);
const dashboardRef = ref(database, 'dashboard_fresh'); // Use a new ref so it doesn't clash with old data
